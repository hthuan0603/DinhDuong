...
describe('HoTro Management Component', () => {
  let comp: HoTroComponent;
  let fixture: ComponentFixture<HoTroComponent>;
  let service: HoTroService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ho-tro', component: HoTroComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(HoTroComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.hoTros?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
