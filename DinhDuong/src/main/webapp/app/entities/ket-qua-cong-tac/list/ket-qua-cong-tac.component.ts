...
export class KetQuaCongTacComponent implements OnInit {
  ...
  protected onSuccess(data: IKetQuaCongTac[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/ket-qua-cong-tac'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
