...
public class HoaDonResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/hoa-dons/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<HoaDon> partialUpdateHoaDon(
        ...
        Optional<HoaDon> result = hoaDonRepository
            ...
            .map(existingHoaDon -> {
                if (hoaDon.getNoiDung() != null) {
                    existingHoaDon.setNoiDung(hoaDon.getNoiDung());
                }
                if (hoaDon.getMaBN() != null) {
                    existingHoaDon.setMaBN(hoaDon.getMaBN());
                }
                if (hoaDon.getMaTheBHYT() != null) {
                    existingHoaDon.setMaTheBHYT(hoaDon.getMaTheBHYT());
                }
                if (hoaDon.getMaDV() != null) {
                    existingHoaDon.setMaDV(hoaDon.getMaDV());
                }
                if (hoaDon.getTamUng() != null) {
                    existingHoaDon.setTamUng(hoaDon.getTamUng());
                }
                if (hoaDon.getDaNop() != null) {
                    existingHoaDon.setDaNop(hoaDon.getDaNop());
                }
                if (hoaDon.getTong() != null) {
                    existingHoaDon.setTong(hoaDon.getTong());
                }
